...
- **Edit** users via a Bootstrap modal (email, optional password reset — blank keeps current)
- **Delete** users with browser confirmation
- Session-protected routes via custom middleware (`isLogin`, `isUserValid`, `isAdminValid`)
