...
- **CRITICAL — File paths NEVER include `OneDrive`.** The real base is `C:\Users\mhodn\Desktop\Essentials\...`, NOT `C:\Users\mhodn\OneDrive\Desktop\Essentials\...`. If a file "disappears", first check you used the correct base path before assuming deletion. (Lesson: wrong path made files appear missing and caused a false-alarm investigation.)
